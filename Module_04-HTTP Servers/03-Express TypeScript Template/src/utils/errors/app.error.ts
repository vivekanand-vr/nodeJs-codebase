 ...
 * @file app.error.ts
 * @description 
 * Contains custom error classes for various HTTP error codes.
 * These errors implement the `AppError` interface and allow structured error handling throughout the application.
 */
